...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-g4ztbe4.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-g4ztbe4.containers.anotherwebservice.com/
...
```
git clone git@github.com:ArashRasti/container-g4ztbe4.git
cd container-g4ztbe4
```
...
```
docker attach container-g4ztbe4
```
